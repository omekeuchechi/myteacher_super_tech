...
const PrivateTutorFormPage = () => {
    ...
    return (
        <div className="private-tutor-form-page">
            <Nav />
            <main className="private-tutor-main">
...
export default PrivateTutorFormPage;